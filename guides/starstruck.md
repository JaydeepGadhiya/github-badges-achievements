...
1. **Build something genuinely useful or fun.** 🛠️
   - A handy CLI tool, a starter template, a curated `awesome-*` list, a cheat sheet, a small library.
2. **Write a great README** — clear title, badges, screenshots/GIFs, quick-start, examples. 📖
3. **Share it** where developers hang out:
   - Reddit (r/programming, niche subs), Hacker News, Dev.to, LinkedIn, X/Twitter, relevant Discord/Slack communities. 📣
4. **Add topics/tags** so it's discoverable in GitHub search. 🏷️
5. **Engage** — respond to issues, thank contributors, keep it maintained. 🤝
